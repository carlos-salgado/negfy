...
class HirshfeldAtom {
 ...
 public:
  ...
  HirshfeldAtom();
  /// Constructor
  HirshfeldAtom(const ErkaleBasisSet & basis, const arma::mat & P, double dr=0.001);
...
class Hirshfeld {
 ...
 public:
  ...
  /// Compute
  void compute(const ErkaleBasisSet & basis, std::string method);
  /// Load from checkpoints
  void load(const ErkaleBasisSet & basis);
