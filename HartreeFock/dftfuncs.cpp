...
void range_separation(int func_id, double & omega, double & alpha, double & beta, bool check) {
	std::cout << "\nENTER dftfuncs.cpp range_separation(int func_id, double & omega, double & alpha, double & beta, bool check)\n";
  // Defaults
  omega=0.0;
  alpha=0.0;
  beta=0.0;
  ...
  std::cout << "\nEXIT dftfuncs.cpp range_separation(int func_id, double & omega, double & alpha, double & beta, bool check)\n";
}
