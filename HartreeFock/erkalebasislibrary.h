 ...
 * momentum, used in the ElementErkaleBasisSet class.
 *
 * \author Susi Lehtola
...
class FunctionShell {
 ...
 public:
  ...
  friend class ErkaleBasisSetLibrary;
};
...
class ElementErkaleBasisSet {
 ...
 public:
  /// Dummy constructor
  ElementErkaleBasisSet();
  /// Constructor
  ElementErkaleBasisSet(std::string sym, size_t number=0);
  /// Destructor
  ~ElementErkaleBasisSet();
  ...
  bool operator<(const ElementErkaleBasisSet &rhs) const;
   ...
   */
  ElementErkaleBasisSet density_fitting(int lmaxinc, double fsam) const;
  /**
   ...
   */
  ElementErkaleBasisSet product_set(int lmaxinc, double fsam) const;

  /// Form compact Cholesky set
  ElementErkaleBasisSet cholesky_set(double thr, int maxam, double ovlthr) const;
...
class ErkaleBasisSetLibrary {
  ...
  std::vector<ElementErkaleBasisSet> elements;

 public:
  /// Constructor
  ErkaleBasisSetLibrary();
  /// Destructor
  ~ErkaleBasisSetLibrary();
  ...
  void add_element(const ElementErkaleBasisSet & el);
  ...
  /// Get elements
  std::vector<ElementErkaleBasisSet> get_elements() const;

  /// Get maximum angular momentum used in basis set
  int get_max_am() const;

  /// Get basis set for wanted element
  ElementErkaleBasisSet get_element(std::string el, size_t number=0) const;
  ...
  ErkaleBasisSetLibrary density_fitting(int lvalinc, double fsam) const;
  /// Generate product set
  ErkaleBasisSetLibrary product_set(int lvalinc, double fsam) const;
  /// Generate compact Cholesky set
//  ErkaleBasisSetLibrary cholesky_set(double thr, int maxam, double ovlthr) const;
