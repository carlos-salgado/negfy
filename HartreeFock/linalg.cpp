...
//void eig_sym_ordered(arma::vec & eigval, arma::mat & eigvec, arma::mat & X) {
  printf("ENTERED eig_sym_ordered(arma::vec & eigval, arma::mat & eigvec, const arma::mat & X)\n");
  ...
  printf("X = \n");
  X.print("X");
  printf("AFTER eig_sym_ordered_wrk<double>(eigval,eigvec,X);\n");
}

void eig_sym_ordered(arma::vec & eigval, arma::cx_mat & eigvec, const arma::cx_mat & X) {
  printf("ENTERED eig_sym_ordered(arma::vec & eigval, arma::cx_mat & eigvec, const arma::cx_mat & X)\n");
  eig_sym_ordered_wrk< std::complex<double> >(eigval,eigvec,X);
  printf("AFTER eig_sym_ordered_wrk< std::complex<double> >(eigval,eigvec,X);\n");
}
...
arma::mat BasOrth(const arma::mat & S, bool verbose) {
  printf("ENTERED BasOrth(const arma::mat & S, bool verbose)\n");
  ...
  arma::vec Sval;
  arma::mat Svec;
  printf("Compute the decomposition\n");
  // Compute the decomposition
  eig_sym_ordered(Sval,Svec,S);
  //printf("AFTER eig_sym_ordered(Sval,Svec,S);\n");
...
arma::mat BasOrth(const arma::mat & S, const Settings & set) {
  printf("ENTERED BasOrth(const arma::mat & S, const Settings & set)\n");
  // Orthogonalize basis
