...
class AngularGrid {
 ...
 public:
  ...
  arma::uvec screen_density(double thr=1e-10) const; // ORIGINAL CODE COMMENTED BY C.SALGADO TO MAKE thr LARGER AND FORCE NOT ALL THE POINTS HAVE TOO SMALL DENSITY.
  //arma::uvec screen_density(double thr=1e-5) const; // MODIFIED CODE COMMENTED BY C.SALGADO TO MAKE thr LARGER AND FORCE NOT ALL THE POINTS HAVE TOO SMALL DENSITY.
  //arma::uvec screen_density(double thr=1e-15) const; // MODIFIED CODE COMMENTED BY C.SALGADO.
  ...
  void print_rho() const; // ADDED BY C.SALGADO.
  ...
  /// Evaluate force, restricted
  arma::vec eval_force_r_Fxc(std::vector< std::vector<arma::mat> > & fmat) const;
  /// Evaluate force, unrestricted
  arma::vec eval_force_u_Fxc(std::vector< std::vector<arma::mat> > & fmat) const;
...
class DFTGrid {
 ...
 public:
  ...
  /// Evaluate force
  arma::vec eval_force(int x_func, int c_func, const arma::mat & P, std::vector< std::vector<arma::mat> > & fmat);
  /// Evaluate force
  arma::vec eval_force(int x_func, int c_func, const arma::mat & Pa, const arma::mat & Pb);
  /// Evaluate force
  arma::vec eval_force(int x_func, int c_func, const arma::mat & Pa, const arma::mat & Pb, std::vector< std::vector<arma::mat> > & fmat);
  /// Evaluate NL force
