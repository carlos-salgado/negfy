...
ErkaleBasisSet::ErkaleBasisSet() {
  // Use spherical harmonics and cartesian functions by default.
  uselm=true;
  optlm=true;
}

ErkaleBasisSet::ErkaleBasisSet(size_t Nat, const Settings & set) {
  // Use spherical harmonics?
...
void ErkaleBasisSet::add_nucleus(const nucleus_t & nuc) {
...
void ErkaleBasisSet::add_shell(size_t nucind, const GaussianShell & sh, bool dosort) {
...
void ErkaleBasisSet::add_shell(size_t nucind, int am, bool lm, const std::vector<contr_t> & C, bool dosort) {
  // Create new shell.
...
void ErkaleBasisSet::add_shells(size_t nucind, ElementErkaleBasisSet el, bool dosort) {
...
void ErkaleBasisSet::check_numbering() {
...
void ErkaleBasisSet::update_nuclear_shell_list() {
...
void ErkaleBasisSet::compute_nuclear_distances() {
  // Amount of nuclei
...
double ErkaleBasisSet::nuclear_distance(size_t i, size_t j) const {
  return nucleardist(i,j);
}

arma::mat ErkaleBasisSet::nuclear_distances() const {
  return nucleardist;
}
...
void ErkaleBasisSet::form_unique_shellpairs() {
...
std::vector<shellpair_t> ErkaleBasisSet::get_unique_shellpairs() const {
...
/*
std::vector<struct eripair_t> ErkaleBasisSet::get_eripairs(arma::mat & screen, double tol, double omega, double alpha, double beta, bool verbose) const {
...
void ErkaleBasisSet::finalize(bool convert, bool donorm) {
...
int ErkaleBasisSet::get_am(size_t ind) const {
  return shells[ind].get_am();
}

int ErkaleBasisSet::get_max_am() const {
  if(shells.size()==0) {
    ERROR_INFO();
...
size_t ErkaleBasisSet::get_max_Ncontr() const {
...
size_t ErkaleBasisSet::get_Nbf() const {
  if(shells.size())
...
void ErkaleBasisSet::compute_shell_ranges(double eps) {
  shell_ranges=get_shell_ranges(eps);
}

std::vector<double> ErkaleBasisSet::get_shell_ranges() const {
  return shell_ranges;
}

std::vector<double> ErkaleBasisSet::get_shell_ranges(double eps) const {
...
std::vector<double> ErkaleBasisSet::get_nuclear_distances(size_t inuc) const {
...
size_t ErkaleBasisSet::get_Ncart() const {
  size_t n=0;
  for(size_t i=0;i<shells.size();i++)
...
size_t ErkaleBasisSet::get_Nlm() const {
  size_t n=0;
  for(size_t i=0;i<shells.size();i++)
    n+=shells[i].get_Nlm();
  return n;
...
size_t ErkaleBasisSet::get_Nbf(size_t ind) const {
  return shells[ind].get_Nbf();
}

size_t ErkaleBasisSet::get_Ncart(size_t ind) const {
  return shells[ind].get_Ncart();
}

size_t ErkaleBasisSet::get_last_ind() const {
  if(shells.size())
...
size_t ErkaleBasisSet::get_first_ind(size_t num) const {
  return shells[num].get_first_ind();
}

size_t ErkaleBasisSet::get_last_ind(size_t num) const {
  return shells[num].get_last_ind();
}

size_t ErkaleBasisSet::find_shell_ind(size_t find) const {
...
size_t ErkaleBasisSet::get_shell_center_ind(size_t num) const {
  return shells[num].get_center_ind();
}

std::vector<GaussianShell> ErkaleBasisSet::get_shells() const {
  return shells;
}

GaussianShell ErkaleBasisSet::get_shell(size_t ind) const {
  return shells[ind];
}

coords_t ErkaleBasisSet::get_shell_center(size_t num) const {
  return shells[num].get_center();
}

std::vector<contr_t> ErkaleBasisSet::get_contr(size_t ind) const {
  return shells[ind].get_contr();
}

std::vector<contr_t> ErkaleBasisSet::get_contr_normalized(size_t ind) const {
  return shells[ind].get_contr_normalized();
}

std::vector<shellf_t> ErkaleBasisSet::get_cart(size_t ind) const {
  return shells[ind].get_cart();
}


bool ErkaleBasisSet::is_lm_default() const {
  return uselm;
}

bool ErkaleBasisSet::lm_in_use(size_t num) const {
  return shells[num].lm_in_use();
}

void ErkaleBasisSet::set_lm(size_t num, bool lm) {
...
arma::ivec ErkaleBasisSet::get_m_values() const {
...
arma::mat ErkaleBasisSet::get_trans(size_t ind) const {
  return shells[ind].get_trans();
}

size_t ErkaleBasisSet::get_Nshells() const {
  return shells.size();
}

size_t ErkaleBasisSet::get_Nnuc() const {
  return nuclei.size();
}

nucleus_t ErkaleBasisSet::get_nucleus(size_t inuc) const {
  return nuclei[inuc];
}

std::vector<nucleus_t> ErkaleBasisSet::get_nuclei() const {
  return nuclei;
}

arma::mat ErkaleBasisSet::get_nuclear_coords() const {
...
void ErkaleBasisSet::set_nuclear_coords(const arma::mat & c) {
...
coords_t ErkaleBasisSet::get_nuclear_coords(size_t inuc) const {
  return nuclei[inuc].r;
}

int ErkaleBasisSet::get_Z(size_t inuc) const {
  return nuclei[inuc].Z;
}

std::string ErkaleBasisSet::get_symbol(size_t inuc) const {
  return nuclei[inuc].symbol;
}

std::string ErkaleBasisSet::get_symbol_hr(size_t inuc) const {
  if(nuclei[inuc].bsse)
...
std::vector<GaussianShell> ErkaleBasisSet::get_funcs(size_t inuc) const {
...
std::vector<size_t> ErkaleBasisSet::get_shell_inds(size_t inuc) const {
...
arma::vec ErkaleBasisSet::eval_func(double x, double y, double z) const {
  // Helper
  coords_t r;
  r.x=x;
  r.y=y;
...
arma::mat ErkaleBasisSet::eval_grad(double x, double y, double z) const {
  // Helper
  coords_t r;
  r.x=x;
  r.y=y;
...
arma::mat ErkaleBasisSet::eval_hess(double x, double y, double z) const {
  // Helper
  coords_t r;
  r.x=x;
  r.y=y;
...
arma::vec ErkaleBasisSet::eval_func(size_t ish, double x, double y, double z) const {
  return shells[ish].eval_func(x,y,z);
}

arma::mat ErkaleBasisSet::eval_grad(size_t ish, double x, double y, double z) const {
  return shells[ish].eval_grad(x,y,z);
}

arma::vec ErkaleBasisSet::eval_lapl(size_t ish, double x, double y, double z) const {
  return shells[ish].eval_lapl(x,y,z);
}

arma::mat ErkaleBasisSet::eval_hess(size_t ish, double x, double y, double z) const {
  return shells[ish].eval_hess(x,y,z);
}

arma::mat ErkaleBasisSet::eval_laplgrad(size_t ish, double x, double y, double z) const {
  return shells[ish].eval_laplgrad(x,y,z);
}

void ErkaleBasisSet::convert_contractions() {
  for(size_t i=0;i<shells.size();i++)
    shells[i].convert_contraction();
}

void ErkaleBasisSet::convert_contraction(size_t ind) {
  shells[ind].convert_contraction();
}

void ErkaleBasisSet::normalize(bool coeffs) {
  for(size_t i=0;i<shells.size();i++)
    shells[i].normalize(coeffs);
}

/*
void ErkaleBasisSet::coulomb_normalize() {
  for(size_t i=0;i<shells.size();i++)
    shells[i].coulomb_normalize();
}
*/

void ErkaleBasisSet::print(bool verbose) const {
...
arma::mat ErkaleBasisSet::cart_to_sph_trans() const {
...
arma::mat ErkaleBasisSet::sph_to_cart_trans() const {
...
void ErkaleBasisSet::set_Nbf( size_t NNbf ) {
  Nbf = NNbf;
}

void ErkaleBasisSet::set_Nel( int NNel ) {
  Nel = NNel;
}

void ErkaleBasisSet::set_mult( int mmult ) {
  mult = mmult;
}


void ErkaleBasisSet::set_S(arma::mat SS) {
  S = SS;
}

arma::mat ErkaleBasisSet::get_S() const {
  return S;
}

arma::mat ErkaleBasisSet::overlap() const {
	return S;
}
/*
arma::mat ErkaleBasisSet::overlap() const {
...
/*
arma::mat ErkaleBasisSet::coulomb_overlap() const {
  // Form overlap matrix
...
arma::mat ErkaleBasisSet::overlap(const ErkaleBasisSet & rhs) const {
...
/*
arma::mat ErkaleBasisSet::coulomb_overlap(const ErkaleBasisSet & rhs) const {
  // Form overlap wrt to other basis set
...
void ErkaleBasisSet::set_T(arma::mat TT) {
  T = TT;
}

arma::mat ErkaleBasisSet::get_T() const {
  return T;
}

arma::mat ErkaleBasisSet::kinetic() const {
	return T;
}
...
void ErkaleBasisSet::set_Vnuc(arma::mat VVnuc) {
  Vnuc = VVnuc;
}

arma::mat ErkaleBasisSet::get_Vnuc() const {
  return Vnuc;
}

arma::mat ErkaleBasisSet::nuclear() const {
	return Vnuc;
}
...
arma::mat ErkaleBasisSet::potential(coords_t r) const {
  // Form nuclear attraction matrix
...
void ErkaleBasisSet::set_Hcore(arma::mat HHcore) {
  Hcore = HHcore;
}

arma::mat ErkaleBasisSet::get_Hcore() const {
  return Hcore;
}
...
/*
arma::mat ErkaleBasisSet::eri_screening(double omega, double alpha, double beta) const {
  // Get unique pairs
...
arma::vec ErkaleBasisSet::nuclear_pulay(const arma::mat & P) const {
...
arma::vec ErkaleBasisSet::nuclear_der(const arma::mat & P) const {
  arma::vec f(3*nuclei.size());
  f.zeros();
...
arma::vec ErkaleBasisSet::kinetic_pulay(const arma::mat & P) const {
  arma::vec f(3*nuclei.size());
  f.zeros();
...
arma::vec ErkaleBasisSet::overlap_der(const arma::mat & P) const {
  arma::vec f(3*nuclei.size());
  f.zeros();
...
arma::vec ErkaleBasisSet::nuclear_force() const {
  arma::vec f(3*nuclei.size());
  f.zeros();
...
std::vector<arma::mat> ErkaleBasisSet::moment(int mom, double x, double y, double z) const {
...
arma::vec ErkaleBasisSet::integral() const {
...
double ErkaleBasisSet::Enuc() const {
  double En=0.0;
...
void ErkaleBasisSet::projectMOs(const ErkaleBasisSet & oldbas, const arma::vec & oldE, const arma::mat & oldMOs, arma::vec & E, arma::mat & MOs, size_t nocc) const {
  if(*this == oldbas) {
    MOs=oldMOs;
    E=oldE;
    return;
  ...
  ErkaleBasisSet transbas(oldbas);
...
void ErkaleBasisSet::projectOMOs(const ErkaleBasisSet & oldbas, const arma::cx_mat & oldOMOs, arma::cx_mat & OMOs, size_t nocc) const {
  if(*this == oldbas) {
    OMOs=oldOMOs;
    return;
  }
...
/*
ErkaleBasisSet ErkaleBasisSet::density_fitting(double fsam, int lmaxinc) const {
...
/*
ErkaleBasisSet ErkaleBasisSet::exchange_fitting() const {
  // Exchange fitting basis set

  Settings set;
  ErkaleBasisSet fit(nuclei.size(),set);
...
bool ErkaleBasisSet::same_geometry(const ErkaleBasisSet & rhs) const {
...
bool ErkaleBasisSet::same_shells(const ErkaleBasisSet & rhs) const {
...
bool ErkaleBasisSet::operator==(const ErkaleBasisSet & rhs) const {
  return same_geometry(rhs) && same_shells(rhs);
}

ErkaleBasisSet ErkaleBasisSet::decontract(arma::mat & m) const {
  ...
  for(size_t inuc=0;inuc<nuclei.size();inuc++) {
    ...
    ElementErkaleBasisSet elbas(get_symbol(inuc));
	...
	for(size_t ish=0;ish<shs.size();ish++) {
	  ...
	  if(pam[am]==-1)
	    ...
	    ERROR_INFO();
	    throw std::runtime_error("ErkaleBasisSet::decontract not implemented for mixed pure am on the same center.\n");
	  }
	}
...
void construct_basis(ErkaleBasisSet & basis, const std::vector<nucleus_t> & nuclei, const ErkaleBasisSetLibrary & baslib, const Settings & set) {
...
void construct_basis(ErkaleBasisSet & basis, const std::vector<atom_t> & atoms, const ErkaleBasisSetLibrary & baslib, const Settings & set) {
  // Number of atoms is
...
arma::vec compute_orbitals(const arma::mat & C, const ErkaleBasisSet & bas, const coords_t & r) {
...
double compute_density(const arma::mat & P, const ErkaleBasisSet & bas, const coords_t & r) {
  // Evaluate basis functions
  arma::vec bf=bas.eval_func(r.x,r.y,r.z);
...
void compute_density_gradient(const arma::mat & P, const ErkaleBasisSet & bas, const coords_t & r, double & d, arma::vec & g) {
  // Evaluate basis functions
  arma::vec bf=bas.eval_func(r.x,r.y,r.z);
  // and gradients
...
void compute_density_gradient_hessian(const arma::mat & P, const ErkaleBasisSet & bas, const coords_t & r, double & d, arma::vec & g, arma::mat & h) {
  // Evaluate basis functions
  arma::vec bf=bas.eval_func(r.x,r.y,r.z);
  // and gradients
  arma::mat grad=bas.eval_grad(r.x,r.y,r.z);
...
double compute_potential(const arma::mat & P, const ErkaleBasisSet & bas, const coords_t & r) {
...
double compute_elf(const arma::mat & P, const ErkaleBasisSet & bas, const coords_t & r) {
  // Evaluate basis functions
  arma::vec bf=bas.eval_func(r.x,r.y,r.z);
  // and gradients
  arma::mat grad=bas.eval_grad(r.x,r.y,r.z);
...
std::vector< std::vector<size_t> > ErkaleBasisSet::find_identical_shells() const {
...
arma::mat construct_IAO(const ErkaleBasisSet & basis, const arma::mat & C, std::vector< std::vector<size_t> > & idx, bool verbose, std::string minbaslib) {
  // Get minao library
  ErkaleBasisSetLibrary minao;
...
arma::cx_mat construct_IAO(const ErkaleBasisSet & basis, const arma::cx_mat & C, std::vector< std::vector<size_t> > & idx, bool verbose, std::string minbaslib) {
  // Get minao library
  ErkaleBasisSetLibrary minao;
  minao.load_basis(minbaslib);
  // Default settings
