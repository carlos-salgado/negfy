...
!                 denerrj,Crit,ANTOn) bind(c)
  SUBROUTINE antc(UHF,JCycle,inputNCycles,Cinputjobname,Cinputjobname_len,&
                 ...
                 outHWFockA,outHWFockB,outGibbsYA,outGibbsYB,outGibbsYKernel1A,outGibbsYKernel1B,outGibbsYKernel2A,outGibbsYKernel2B,CinputIAN,CinputJAN,CinputAOS,CinputShellT,CinputShellC,&
...
!  real(c_double),DIMENSION(inputNSpin,NBasis,NBasis),INTENT(in) :: pivFock, pivExchange
  ...
  real(c_double),DIMENSION(NBasis,NBasis),INTENT(out) :: outGibbsYA, outGibbsYB, outGibbsYKernel1A, outGibbsYKernel1B, outGibbsYKernel2A, outGibbsYKernel2B
...
!  integer(C_INT), intent(IN), VALUE :: inputjobname_len
  integer, intent(IN), VALUE :: inputjobname_len
!  character(inputjobname_len,kind=C_CHAR), intent(IN) :: inputjobname
  character(inputjobname_len), intent(IN) :: inputjobname
